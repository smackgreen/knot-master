...
const ICON_MAP: Record<string, { component: React.ElementType; color: string; bg: string }> = {
  ...
  ring: { component: Ring, color: 'text-yellow-600', bg: 'bg-yellow-50' },
  champagne: { component: Champagne, color: 'text-amber-600', bg: 'bg-amber-50' },
...
const DEFAULT_EVENTS: TimelineEvent[] = [
  ...
  { id: '13', title: 'Dites Oui !', durationMinutes: 15, icon: 'ring' },
  { id: '14', title: 'Cocktails et photos', durationMinutes: 20, icon: 'champagne' },
  ...
  { id: '19', title: 'Toasts & Prières', durationMinutes: 40, icon: 'champagne' },
